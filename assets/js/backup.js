...
gameRef.on('value', function(snapshot) {
    ...
    if (typeof p1Choice != "undefined" && typeof p2Choice != "undefined") {
        ...
        if (p1Choice === p2Choice) {
            actionMessage("Tie!  Play again...", "alert-light");
        }

        // Player 1 winning scenarios
        // Rock beats Scissors
        if (p1Choice === "rock" && p2Choice === "scissors") {
            actionMessage("Rock beats Scissors... Player 1 wins", "alert-light");
            p1wins += 1;
        }
        // Scissors beats Paper
        if (p1Choice === "scissors" && p2Choice === "paper") {
            actionMessage("Scissors beats Paper... Player 1 wins", "alert-light");
            p1wins += 1;
        }
        // Paper beats Rock
        if (p1Choice === "paper" && p2Choice === "rock") {
            actionMessage("Paper beats Rock... Player 1 wins", "alert-light");
            p1wins += 1;
        }
        ...
        if (p2Choice === "rock" && p1Choice === "scissors") {
            actionMessage("Rock beats Scissors... Player 2 wins", "alert-light");
            p2wins += 1;
        }
        // Scissors beats Paper
        if (p2Choice === "scissors" && p1Choice === "paper") {
            actionMessage("Scissors beats Paper... Player 2 wins", "alert-light");
            p2wins += 1;
        }
        // Paper beats Rock
        if (p2Choice === "paper" && p1Choice === "rock") {
            actionMessage("Paper beats Rock... Player 2 wins", "alert-light");
            p2wins += 1;
        }
